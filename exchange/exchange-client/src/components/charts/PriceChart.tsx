...
const dayData: { time: string; value: number }[] = [
...
const weekData: { time: string; value: number }[] = [
...
const monthData: { time: string; value: number }[] = [
...
const yearData: { time: string; value: number }[] = [
...
const PriceChart = ({
  ...
  useEffect(() => {
    ...
    function setChartInterval(interval: TimeRange) {
      lineSeries.setData(seriesesData[interval]);
      chart.timeScale().fitContent();
    }

    setChartInterval(range);
  ...
  return (
    <div>
      <div>
        <Button variant="outline" className="mr-2" onClick={() => setRange("1D")}>1D</Button>
        <Button variant="outline" className="ml-2 mr-2" onClick={() => setRange("1W")}>1W</Button>
        <Button variant="outline" className="ml-2 mr-2" onClick={() => setRange("1M")}>1M</Button>
        <Button variant="outline" className="ml-2" onClick={() => setRange("1Y")}>1Y</Button>
      </div>
